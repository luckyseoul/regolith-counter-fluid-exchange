...
**Internal working draft only — not for direct filing. Aligns with RCFX Rev 5.2 and COLD review. Narrows to Option A envelope supported by good-variable real-drag physical-lid GPU DEM.**
