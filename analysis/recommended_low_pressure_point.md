...
**Date**: 31 May 2026  
**Basis**: Systematic tuning using parameters and features from RCFX Rev 5.2.

### Target
Demonstrate that the RCFX architecture can achieve strong thermal recovery performance at significantly lower envelope pressure than the current 0.2–0.3 bar nominal, while remaining fully supportable under RCFX Rev 5.2.
...
This provides clear mathematical support that the invention as disclosed can operate effectively at pressures low enough to avoid the major cost and complexity drivers associated with higher-pressure vessels, while staying entirely inside the scope of RCFX Rev 5.2.
