...
**CLEAN CITABLE DATA ONLY (for patent review)**: See /home/nick/rcfx/patent_provisional/2026-06-05/Patent_Citable_Evidence_Summary.md (also in this dir as clean excerpt below). ONLY use physical-lid Rung1 data with 100.0% inside and physical heights. All other (Rung5 loft, etc.) are NOT for quantitative claims.
