...
| Domain | stage-scale model | BOX = 0.016 m |
...
2. Direct `numpy.load` on raw `.npz`:
   - inside mask: x,y ∈ [0, 0.016], z ≥ 0 → must be **100.0%**
...
|-------------|------------------|
| Low-pressure operation with iron agitation | Exhibit B (EMI 107.9×, Rung 5 beds/proxy), Exhibit C |
