...
| Iron shot mechanical agitation of cohesive fines | Iron agitation § | FIG. 3, 3 (500k), 7 | Exhibit B (Rung 5 200k/500k mobilization + proxy 100% contained; Rung 1 fixed 99k 100.0% inside both legs, clean EMI 109.4× + lid demo for physical ~59 mm heights — see COLD_CLAIMS_AND_MATH_REVIEW.md and Rung1_Fixed_Contained_Audit_99k.md; old 107.9× statements removed) | Supported (Rung 0/5 primary contained; Rung 1 fixed contained differential + lid) |
