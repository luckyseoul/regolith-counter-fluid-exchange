...
- patent_drawings/ (FIG_01–07 + S* variants including iron size and perf scaling; black & white vector per 37 CFR 1.84)
...
Quantitative DEM support is the physical-lid high-N Rung 1 series and iron-size sensitivities (`Patent_Citable_Evidence_Summary.md`). Rung 0 is the distributor baseline. Rung 5 is qualitative robustness only.
...
There is no hardware prototype. Enablement is from the lumped model, the custom GPU DEM (physical-lid high-N Rung 1), the detailed description, and the drawings.
