...
if __name__ == "__main__":
    ...
    pos, vel, omega, radius, mat_type = generate_rung2_particles(n_total=3500, iron_frac=0.0)
    ...
    out = {
        ...
        'note': 'Production Rung 2 at exact 0.14 bar 221 W point with no-iron control (identical U_G and drag law). For patent evidence.'
    }
    np.savez('rung2_noiron_control_0.14bar.npz', **out)
    print("Saved rung2_noiron_control_0.14bar.npz")
    ...
    np.savez('rung2_noiron_control_summary.npz', **summary)
    print("Saved rung2_noiron_control_summary.npz")
